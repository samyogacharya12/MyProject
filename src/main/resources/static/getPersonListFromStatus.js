GET:$(document).ready(
    function () {
        ...
        $("#statusForm").submit(function (event) {
            ...
            getPersonrDataByStatus();
        });

        function getPersonrDataByStatus() {
            var status = $("#personListOption").val();
            console.log(personListOption);
            $.ajax({
                type: "GET",
                url: "/getListOfPersonFromStatus" + "/" + status,
                success: function (result) {
                    ...
                    $.each(result, function (i, personList) {
                        ...
                        var person = '<tr>' +
                            ...
                            '</tr>';
                        $('#personList #personDataByStatus').append(person);
                    })
                    },
                error: function (e) {
                    alert("ERROR: ", e);
